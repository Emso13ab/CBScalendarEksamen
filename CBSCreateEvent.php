...
<head>
<link type="text/css" rel="stylesheet" href="CBSCreateEvent.css"/>
...
<body>
    ...
    <!-- Textareas for events -->
		<form action="demo_form.asp">
  			...
  			<input id="eventinfo" type="text" name="location" placeholder="Event Location"><br>
